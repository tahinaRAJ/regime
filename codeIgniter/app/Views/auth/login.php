...
<form class="harmony-form" id="loginForm" method="post" action="<?= base_url('login') ?>" novalidate>
    ...
    <div class="organic-field">
        ...
        <input type="email" id="email" name="email" value="jean@test.fr" required autocomplete="email">
    ...
    <div class="organic-field">
        <div class="field-nature"></div>
        <input type="password" id="password" name="password" value="Admin@1234" required autocomplete="current-password">
